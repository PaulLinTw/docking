...
export GF_SMTP_MAIL_ENCRYPTION="tls"
export GF_SMTP_HOST="smtp.gmail.com:587"
export GF_SMTP_USER="paoshui@gmail.com"
export GF_SMTP_PASSWORD="rilljetfsxrdbmeh"
export GF_SMTP_FROM_ADDRESS="paoshui@gmail.com"
export GF_SMTP_FROM_NAME="BlueTechnology Demo"
