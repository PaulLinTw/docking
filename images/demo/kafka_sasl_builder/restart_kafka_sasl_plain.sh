...
export KAFKA_OPTS="-Djava.security.auth.login.config=/jaas/broker.jaas -javaagent:/kafka/jmx_prometheus_javaagent-0.2.1-SNAPSHOT.jar=7071:/kafka/kafka-0-8-2.yml"
