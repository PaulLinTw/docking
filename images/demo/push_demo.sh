...
sudo docker push $registry/demo/zookeeper
sudo docker push $registry/demo/kafka
sudo docker push $registry/demo/redis
sudo docker push $registry/demo/prometheus
sudo docker push $registry/demo/km
sudo docker push $registry/demo/mongodb
