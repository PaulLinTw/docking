...
docker run -d --net=multi --name=mongoc1 --expose 30000 \
...
docker run -d --net=multi --name=mongo_primary1 --expose 20000 \
...
docker run -d --net=multi --name=mongo_secondary3 --expose 20001 \
...
docker run -d --net=multi --name=mongo_arbiter1 --expose 20002 \
...
docker run -d --net=multi --name=mongoc2 --expose 30000 \
-v mongodb_configsvr:/var/lib/mongodb/configsvr \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
bash -c "mongod --configsvr --replSet rs1 --storageEngine wiredTiger --port 30000 --dbpath /var/lib/mongodb/configsvr --logpath /var/lib/mongodb/configsvr/config.log --logappend"

echo "create mongo_primary2 container"
docker run -d --net=multi --name=mongo_primary2 --expose 20000 \
-v mongodb_primary:/var/lib/mongodb/primary \
-v /home/$user/confs/mongodb.primary.conf:/confs/mongodb.primary.conf \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
...
docker run -d --net=multi --name=mongo_secondary1 --expose 20001 \
-v mongodb_secondary:/var/lib/mongodb/secondary \
-v /home/$user/confs/mongodb.secondary.conf:/confs/mongodb.secondary.conf \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
...
docker run -d --net=multi --name=mongo_arbiter2 --expose 20002 \
-v mongodb_arbiter:/var/lib/mongodb/arbiter \
-v /home/$user/confs/mongodb.arbiter.conf:/confs/mongodb.arbiter.conf \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
...
docker run -d --net=multi --name=mongoc3 --expose 30000 \
-v mongodb_configsvr:/var/lib/mongodb/configsvr \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
bash -c "mongod --configsvr --replSet rs1 --storageEngine wiredTiger --port 30000 --dbpath /var/lib/mongodb/configsvr --logpath /var/lib/mongodb/configsvr/config.log --logappend"

echo "create mongo_primary3 container"
docker run -d --net=multi --name=mongo_primary3 --expose 20000 \
-v mongodb_primary:/var/lib/mongodb/primary \
-v /home/$user/confs/mongodb.primary.conf:/confs/mongodb.primary.conf \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
...
docker run -d --net=multi --name=mongo_secondary2 --expose 20001 \
-v mongodb_secondary:/var/lib/mongodb/secondary \
-v /home/$user/confs/mongodb.secondary.conf:/confs/mongodb.secondary.conf \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
...
docker run -d --net=multi --name=mongo_arbiter3 --expose 20002 \
-v mongodb_arbiter:/var/lib/mongodb/arbiter \
-v /home/$user/confs/mongodb.arbiter.conf:/confs/mongodb.arbiter.conf \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongodb:latest \
...
docker run -d --net=multi --name=mongos -p 40000:40000 \
...
docker run -d --net=multi --name=exporter1 --expose 9001 \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongoexporter:latest \
...
docker run -d --net=multi --name=exporter2 --expose 9001 \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongoexporter:latest \
...
docker run -d --net=multi --name=exporter3 --expose 9001 \
btgit.eastasia.cloudapp.azure.com:5000/demo/mongoexporter:latest \
