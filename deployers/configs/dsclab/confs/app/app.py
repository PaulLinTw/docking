...
def register_blueprints(app):
    for module_name in ('abouts', 'base', 'dashboards', 'countries', 'products', 'visits', 'actions'):
...
def create_app(selenium=False):
    ...
    app.jinja_env.globals['countries'] = incl.countrylist
    app.jinja_env.globals['products'] = incl.productlist
    app.jinja_env.globals['actions'] = incl.actionlist
    app.jinja_env.globals['visits'] = incl.visitlist
